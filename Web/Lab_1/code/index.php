...
/** 11. Комбинация функций */
// 1. Среднее арифмитическое
$num = [10, 12, 323, 4, 43, 54];
$arithmeticMean = array_sum($num)/sizeof($num);
echo "$arithmeticMean\n";

// 2. Найдйдём сумму чисел от 1 до 100
$sum = array_sum(range(1,100)); // созадаем массив от 1 до 100 и сумируем между собой все элименты
echo "$sum\n";

// 3. Получим из массива массив с квадратными корнями чисел первого массива
$arr1 = [36, 25, 9, 121, 448];
$arr2 = array_map('sqrt', $arr1);
var_export($arr2);
echo "\n";
// 4. Заполним массив числами от 1 до 26 так, чтобы ключами
// этих чисел были буквы английского алфавита: ['a'=>1, 'b'=>2...].
$keys = range('a', 'z'); // создаём массив из букв по алфавиту
$values = range(1, 26); // сошдаём массив от 1 до 26
$alphabetArray = array_combine($keys, $values); // объединям
var_export($alphabetArray);
echo "\n";
// 5. Дана строка с числами '1234567890'. Найдите сумму пар чисел: 12+34+56+78+90
$str = '1234567890';
$chunks = str_split($str, 2); // Разбиваем строку на пары чисел
$sum = array_sum($chunks); // Суммируем пары чисел
echo "$sum\n";